...
class CertPayStatusResponseData implements \JsonSerializable
{
    /**
    ...
    public static function cast(CertPayStatusResponseData $destination, ?\stdClass $source): CertPayStatusResponseData
    {
        if ($source) {
